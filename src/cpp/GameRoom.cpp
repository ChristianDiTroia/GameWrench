...
void gw::GameRoom::addSprite(Sprite* sprite) { sprites.push_back(sprite); }

void gw::GameRoom::addSprite(AnimatedSprite* animSprite) { animSprites.push_back(animSprite); }